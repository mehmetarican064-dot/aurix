...
window.AURIX_DATA = {
    ...
    VARSAYILAN_GORSEL: 'assets/images/firma.svg',
    VARSAYILAN_MALZEME_GORSEL: 'assets/images/malzeme.svg',

    /* Kategori bazlı yerel kapak görselleri */
    KATEGORI_KAPAK_GORSELLERI: {
        cizimci: 'assets/images/cad.svg',
        matrix: 'assets/images/cad.svg',
        rhino: 'assets/images/cad.svg',
        dokumcu: 'assets/images/dokum.svg',
        mumcu: 'assets/images/dokum.svg',
        kalipci: 'assets/images/dokum.svg',
        mihlamaci: 'assets/images/mihlama.svg',
        tas: 'assets/images/tas.svg',
        ayar: 'assets/images/firma.svg',
        ramat: 'assets/images/firma.svg',
        polisaj: 'assets/images/malzeme.svg',
        lazer: 'assets/images/makine.svg',
        makine: 'assets/images/makine.svg',
        zincir: 'assets/images/firma.svg',
        kilit: 'assets/images/malzeme.svg',
        bilezik: 'assets/images/firma.svg',
        toptanci: 'assets/images/firma.svg',
        vitrin: 'assets/images/firma.svg',
        kutu: 'assets/images/malzeme.svg',
        malzeme: 'assets/images/malzeme.svg',
        sarf: 'assets/images/malzeme.svg',
        kimyasal: 'assets/images/malzeme.svg',
        tel: 'assets/images/malzeme.svg',
        lehim: 'assets/images/malzeme.svg',
        aparat: 'assets/images/malzeme.svg',
        kaplama: 'assets/images/malzeme.svg',
        tamir: 'assets/images/firma.svg'
    },

    MALZEME_KATEGORI_GORSELLERI: {
        'lazer-makine': 'assets/images/makine.svg',
        'dokum-makine': 'assets/images/makine.svg',
        motor: 'assets/images/makine.svg',
        mikromotor: 'assets/images/makine.svg',
        'mihlama-alet': 'assets/images/mihlama.svg',
        hammadde: 'assets/images/malzeme.svg',
        aksesuar: 'assets/images/tas.svg',
        'kalip-malzeme': 'assets/images/dokum.svg',
        parlatma: 'assets/images/malzeme.svg',
        polisaj: 'assets/images/malzeme.svg',
        rodaj: 'assets/images/malzeme.svg',
        kimyasal: 'assets/images/malzeme.svg',
        sarf: 'assets/images/malzeme.svg',
        terazi: 'assets/images/makine.svg',
        freze: 'assets/images/makine.svg',
        matkap-uc: 'assets/images/malzeme.svg',
        kalem: 'assets/images/malzeme.svg',
        pense: 'assets/images/malzeme.svg',
        cimoz: 'assets/images/malzeme.svg',
        'el-alet': 'assets/images/malzeme.svg',
        'yedek-parca': 'assets/images/makine.svg'
    },
